...
DROP TRIGGER IF EXISTS update_account_permissions_updated_at ON account_permissions;
...
BEGIN
  ...
  DROP POLICY IF EXISTS "Account owners can manage permissions" ON account_permissions;
  DROP POLICY IF EXISTS "Collaborators can view permissions" ON account_permissions;
  DROP POLICY IF EXISTS "Account owners can manage invites" ON collaboration_invites;
...
DROP INDEX IF EXISTS idx_account_permissions_owner;
DROP INDEX IF EXISTS idx_account_permissions_collaborator;
DROP INDEX IF EXISTS idx_collaboration_invites_owner;
